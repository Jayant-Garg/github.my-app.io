...
export default function About() {
  return (
    <div className="container mt-5">
      <h2 className="text-center">Bootstrap 5 Accordion</h2>
      ...
      <div className="accordion accordion-flush mt-4" id="accordionExample">
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              Java is a programming language that is used in modern development
              worldwide.
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              C++ is a high-level programming language used for developing
